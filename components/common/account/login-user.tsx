import { DeleteAccountModal, LogoutModal } from "@/components/modal";
...
export default function LoginUserAccount() {
    ...
    const handleConfirmDelete = (password: string) => {
        console.log("Delete account requested with password:", password);
    ...
    return (
        <>
            ...
            >
                ...
                <View style={tw`w-full gap-3`}>
                    ...
                    <MenuItem
                        ...
                        onPress={() => {
                            router.push({
                                pathname: "/(common)/settings/support",
                            });
                        }}
                    />
                    ...
                    <MenuItem
                        ...
                        onPress={() => setState("deleteAccount", true)}
                    />
            ...
            <LogoutModal
                ...
                onClose={() => setState("logout", false)}
                onConfirm={handleConfirmLogout}
            />

            <DeleteAccountModal
                visible={state.deleteAccount}
                onClose={() => setState("deleteAccount", false)}
